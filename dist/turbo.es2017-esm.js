...
//? https://turbo.hotwired.dev/reference/frames#eager-loaded-frame
...
class Visit {
    constructor(delegate, location, restorationIdentifier, options = {}) {
        ...
        const { action, historyChanged, referrer, snapshotHTML, response, visitCachedSnapshot, willRender, updateHistory, shouldCacheSnapshot, } = Object.assign(Object.assign({}, defaultOptions), options);
        this.action = action;
